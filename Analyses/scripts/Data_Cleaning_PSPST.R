...
write_csv(tbl, "licordataPSP1.csv")


### add species and site data in excel (figure out a better way to do this!)
licordata <- read_csv("~/Documents/Ph.D/LI-COR Data (pacific spirit park)/licordataPSP1.csv")
...
write_csv(lightdatawide, "LiCordatafinalpsp.csv")
